...
function send() {
  ...
  if(url === "" || typeof url === 'undefined' || url === null) return alert('Webhook URL must not be empty!');
  if(content === "" || typeof content === 'undefined' || content === null) return alert('Message content must not be empty!');
